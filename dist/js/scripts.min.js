...
$(document).ready(function(){$(".parallax-window").parallax({imageSrc:"/images/mac.jpeg"}),$(".pre-portfolio-parallax").parallax({imageSrc:"/images/portfolio.jpeg"});var o=$("#owl-slider");o.owlCarousel({autoHeight:!0,navigation:!0,singleItem:!0,responsive:!0,transitionStyle:"backSlide"}),$("#portfolio .item").mouseover(function(){$(".project-overlay").css("height","100%")}),$("#portfolio .item").mouseleave(function(){$(".project-overlay").css("height","0")}),$("#openNav").click(function(){console.log("hit nav btn"),$(".landing-text").hide(),$(".nav-btn").hide(),$("#mobileNav").css("height","100%")}),$(".closebtn").click(function(){$(".landing-text").show(),$(".nav-btn").show(),$("#mobileNav").css("height","0%")}),$(".overlay-content a").click(function(){$("#mobileNav").css("height","0%"),$(".landing-text").show(),$(".nav-btn").show()}),$(function(){$(".card").on("tap",function(){$(".card").style.transform="rotate(180deg)",console.log("hit it")}),$(".card-text").on("tap",function(){$(".card").style.transform="rotate(180deg)"})});var t=300,e=1200,i=700,l=$(".top");$(window).scroll(function(){$(this).scrollTop()>t?l.addClass("top-is-visible"):l.removeClass("top-is-visible top-fade-out"),$(this).scrollTop()>e&&l.addClass("top-fade-out")}),$(window).scroll(function(){$(window).scrollTop()<50&&($(".nav").removeClass("fixed"),$(".title").removeClass("title-fixed"),$(".links").removeClass("links-fixed"),$("h2").removeClass("title-color"),$(".links-div").removeClass("links-fixed")),$(window).scrollTop()>50&&($(".nav").addClass("fixed"),$(".title").addClass("title-fixed"),$(".links-div").addClass("links-fixed"),$("h2").addClass("title-color"))}),$(".top").click(function(o){o.preventDefault(),$("html, body").animate({scrollTop:0},i)}),$('a[href^="#"]').click(function(o){o.preventDefault();var t=$(this).attr("href"),e=$(t).offset().top-40;$("html, body").animate({scrollTop:e},1200,function(){window.location.hash=""+t}),$(window).on("hashchange",function(o){history.replaceState("",document.title,o.originalEvent.oldURL)})})});